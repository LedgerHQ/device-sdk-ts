...
import { useSignerConcordium } from "@/providers/SignerConcordiumProvider";

export const SignerConcordiumView: React.FC<{ sessionId: string }> = ({
  sessionId,
}) => {
  const dmk = useDmk();
  const signer = useSignerConcordium();
  ...
  return (
    <DeviceActionsList title="Signer Concordium" deviceActions={deviceActions} />
  );
};
