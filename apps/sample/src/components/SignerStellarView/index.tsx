...
import { useSignerStellar } from "@/providers/SignerStellarProvider";

export const SignerStellarView: React.FC<{ sessionId: string }> = ({
  sessionId,
}) => {
  const dmk = useDmk();
  const signer = useSignerStellar();
  ...
  return (
    <DeviceActionsList title="Signer Stellar" deviceActions={deviceActions} />
  );
};
