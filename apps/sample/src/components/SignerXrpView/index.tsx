...
import { useSignerXrp } from "@/providers/SignerXrpProvider";

export const SignerXrpView: React.FC<{ sessionId: string }> = ({
  sessionId,
}) => {
  const dmk = useDmk();
  const signer = useSignerXrp();
  ...
  return <DeviceActionsList title="Signer Xrp" deviceActions={deviceActions} />;
};
