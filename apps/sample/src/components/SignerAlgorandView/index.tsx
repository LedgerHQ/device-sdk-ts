...
import { useSignerAlgorand } from "@/providers/SignerAlgorandProvider";

export const SignerAlgorandView: React.FC<{ sessionId: string }> = ({
  sessionId,
}) => {
  const dmk = useDmk();
  const signer = useSignerAlgorand();
  ...
  return (
    <DeviceActionsList title="Signer Algorand" deviceActions={deviceActions} />
  );
};
