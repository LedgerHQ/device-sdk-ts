...
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| Device Signer Ethereum    | [@ledgerhq/device-signer-kit-ethereum](https://www.npmjs.com/package/@ledgerhq/device-signer-kit-ethereum)                                         | 1.12.0  |
...
| Device Signer Solana      | [@ledgerhq/device-signer-kit-solana](https://www.npmjs.com/package/@ledgerhq/device-signer-kit-solana)                                             | 1.7.1   |
...
| Device Signer Hyperliquid | [@ledgerhq/device-signer-kit-hyperliquid](https://www.npmjs.com/package/@ledgerhq/device-signer-kit-hyperliquid)                                   | 1.0.1   |
