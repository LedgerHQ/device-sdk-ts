...
| Device Signer Ethereum     | [@ledgerhq/device-signer-kit-ethereum](https://www.npmjs.com/package/@ledgerhq/device-signer-kit-ethereum)     | 1.5.0   |
...
| WebHid Transport           | [@ledgerhq/device-transport-kit-web-hid](https://www.npmjs.com/package/@ledgerhq/device-transport-kit-web-hid) | 1.1.0   |
...
| React Native Ble Transport | [@ledgerhq/device-transport-kit-rn-ble](https://www.npmjs.com/package/@ledgerhq/device-transport-kit-rn-ble)   | 1.0.0   |
