...
Now you can click on the "Connect your signer" button and a modal will be opened.
Click on the Ledger logo.

![Choice of signer](/device-interaction/tutorial-1-solana-signer.png)  
_Fig. 6: Choice of signer_
