...
Before startint, make sure you have gone through the [prerequisites](../info#prerequisites).

### Install the Solana Embedded App

First you need to install the Solana Embedded App from Ledger Live as shown in the [prerequisites](../info#prerequisites) for Ethereum.
