...
When there is no available Nano API, the way to make your Nano calls is by constructing the APDU call yourself, by using the syntax information found in each application documentation.
