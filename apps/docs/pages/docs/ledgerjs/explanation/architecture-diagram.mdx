...
![Ledger Wallet Prerequisites](/device-interaction/application-architecture.png)
...
- **Ledger JS Transport API:** packages that allow you to implement several kind communication between the software wallet and a Ledger signer
- **Ledger JS Dedicated App Lib:** packages that allow you to communicate with specific Ledger Embedded Apps
- **Embedded App:** the application that run on a Ledger signer to interact with a specific blockchain
