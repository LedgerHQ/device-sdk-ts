...
We encourage you to explore these device actions by trying them out in our online [sample application](https://app.devicesdk.ledger-test.com/). Experience how they work and see its capabilities in action. Of course, you will need a Ledger device connected.
