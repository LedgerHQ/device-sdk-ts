...
4. [Use Cases](#-use-cases)
   ...
   - [Get View Key](#use-case-3-get-view-key)
...
- `derivationPath`
  ...
  - **Required**
  - **Type:** `string` (e.g., `"m/44'/683'/0"`)
  - The derivation path used for the aleo view key. See [here](https://www.ledger.com/blog/understanding-crypto-addresses-and-derivation-paths) for more information.
