...
4. [Use Cases](#-use-cases)
   ...
   - [Get signer address](#use-case-5-get-wallet-address)
...
- `derivationPath`
  ...
  - **Required**
  - **Type:** `string` (e.g. `"84'/0'/0'"` for a Native SegWit signer)
...
### Use Case 5: Get signer address

This method allows users to get the signer address linked to a Ledger device.

```typescript
const { observable, cancel } = signerBitcoin.getsignerAddress(
  derivationPath,
  addressIndex,
  options,
);
