...
- [Initializing the DMK](./init_dmk)
- [Connecting to a Device](./discover_and_connect)
...
- Learn how to [build custom commands](../integration/how_to/build_custom_command) for specific applications
