...
Before starting this tutorial, make sure you have initialized the DMK instance and imported it in your project. If you haven't done so, please refer to the [Initializing the DMK](./init_dmk) tutorial.
