...
| Path             | Contents                                                                                                     |
| ---------------- | ------------------------------------------------------------------------------------------------------------ |
| `src/api`        | The typed `fetch` client for the mock server.                                                                |
...
| `src/lib`        | Domain knowledge with no UI: device models, APDU builders and status words, mock presets, remembered tokens. |
