...
const SYSTEM_PROMPT_ANALYZE = `You are a Ledger device debugging expert. You analyze DMK (Device Management Kit) logs to diagnose issues with Ledger device communication.
