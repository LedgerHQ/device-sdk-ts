...
import ABI from "@/loaders/ethereum/external-plugin/__tests__/abi.json";
import { type ExternalPluginDataSource } from "@/loaders/ethereum/external-plugin/data/ExternalPluginDataSource";
import {
  type ExternalPluginContextInput,
  ExternalPluginContextLoader,
} from "@/loaders/ethereum/external-plugin/domain/ExternalPluginContextLoader";
import { type DappInfos } from "@/loaders/ethereum/external-plugin/model/DappInfos";
import { type SelectorDetails } from "@/loaders/ethereum/external-plugin/model/SelectorDetails";
import { type TokenDataSource } from "@/loaders/ethereum/token/data/TokenDataSource";
import { type UniswapContextLoader } from "@/loaders/ethereum/uniswap/domain/UniswapContextLoader";
...
describe("ExternalPluginContextLoader", () => {
  ...
  describe("canHandle function", () => {
    ...
    it("should return false for invalid expected type", () => {
      expect(
        loader.canHandle(validInput, [ClearSignContextType.ETHEREUM_NFT]),
      ).toBe(false);
      expect(
