...
import type { CalldataDescriptorDataSource } from "@/loaders/ethereum/calldata/data/CalldataDescriptorDataSource";
import {
  type CalldataContextInput,
  CalldataContextLoader,
} from "@/loaders/ethereum/calldata/domain/CalldataContextLoader";
