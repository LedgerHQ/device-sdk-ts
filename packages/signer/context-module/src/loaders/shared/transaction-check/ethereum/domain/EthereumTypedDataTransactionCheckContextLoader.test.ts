...
import {
  type EthereumTypedDataTransactionCheckContextInput,
  EthereumTypedDataTransactionCheckContextLoader,
  type TypedData,
} from "@/loaders/shared/transaction-check/ethereum/domain/EthereumTypedDataTransactionCheckContextLoader";
...
describe("EthereumTypedDataTransactionCheckContextLoader", () => {
  ...
  const loader = new EthereumTypedDataTransactionCheckContextLoader(
  ...
  describe("canHandle function", () => {
    ...
    const validInput: EthereumTypedDataTransactionCheckContextInput = {
