...
import { type NftDataSource } from "@/ethereum-loaders/nft/data/NftDataSource";
import {
  type NftContextInput,
  NftContextLoader,
} from "@/ethereum-loaders/nft/domain/NftContextLoader";
...
describe("NftContextLoader", () => {
  ...
  beforeEach(() => {
    ...
    loader = new NftContextLoader(mockDataSource, mockLoggerFactory);
  });
  ...
  describe("canHandle function", () => {
    ...
    it("should return false for invalid expected type", () => {
      ...
      expect(
        loader.canHandle(validInput, [ClearSignContextType.ETHEREUM_PLUGIN]),
      ).toBe(false);
      expect(
