...
import type { CalldataDescriptorDataSource } from "@/ethereum-loaders/calldata/data/CalldataDescriptorDataSource";
import {
  type CalldataContextInput,
  CalldataContextLoader,
} from "@/ethereum-loaders/calldata/domain/CalldataContextLoader";
...
describe("CalldataContextLoader", () => {
  ...
  describe("canHandle function", () => {
    ...
    it("should return false for invalid expected type", () => {
      ...
      expect(
        loader.canHandle(validInput, [ClearSignContextType.ETHEREUM_ENUM]),
      ).toBe(false);
      expect(
        loader.canHandle(validInput, [
          ClearSignContextType.ETHEREUM_TRANSACTION_INFO,
