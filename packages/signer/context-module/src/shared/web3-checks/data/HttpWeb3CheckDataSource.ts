...
import { Web3CheckDataSource, Web3CheckParams, Web3CheckResult } from "./Web3CheckDataSource";
...
export class HttpWeb3CheckDataSource implements Web3CheckDataSource {
  ...
  public async check({
    ...
    return Right({ publicKeyId: dto.public_key_id, descriptor: dto.descriptor });
  }
