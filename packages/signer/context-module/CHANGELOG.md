...
- [#1893](https://github.com/LedgerHQ/device-sdk-ts/pull/1893) [`1fe060e`](https://github.com/LedgerHQ/device-sdk-ts/commit/1fe060e78f76b03960c0a23c6bb93fa54cad8915) Thanks [@aussedatlo](https://github.com/aussedatlo)! - Add a Tron chain with a TRC10 token loader, resolving the token descriptor from the transaction alone

- [#1834](https://github.com/LedgerHQ/device-sdk-ts/pull/1834) [`f275d1e`](https://github.com/LedgerHQ/device-sdk-ts/commit/f275d1ea15dc3a4fd58379c47a5219b1f84967de) Thanks [@paoun-ledger](https://github.com/paoun-ledger)! - Surface the Solana CAL instruction-descriptor fields the requirement builder was dropping: `hide_rules` and `owner_association`, plus `TOKEN_VALUE.FALLBACK_ACCOUNT` and `VALUE_FLOW_PORT.ACTIVE_WHEN` on the port shapes.
...
- [#1881](https://github.com/LedgerHQ/device-sdk-ts/pull/1881) [`c6a2056`](https://github.com/LedgerHQ/device-sdk-ts/commit/c6a205652ebb21f154b26f6dda2b22d7119ccbaa) Thanks [@fAnselmi-Ledger](https://github.com/fAnselmi-Ledger)! - nativePreBalance DTO + owner-without-mint warn for TOKEN_ACCOUNT_STATE
...
- [#1679](https://github.com/LedgerHQ/device-sdk-ts/pull/1679) [`5cea7e4`](https://github.com/LedgerHQ/device-sdk-ts/commit/5cea7e4f958a6cabb5604d7b03ec89245ca5b4a9) Thanks [@fAnselmi-Ledger](https://github.com/fAnselmi-Ledger)! - Add mintToId datasource for Solana token loader

- [#1736](https://github.com/LedgerHQ/device-sdk-ts/pull/1736) [`f69cebd`](https://github.com/LedgerHQ/device-sdk-ts/commit/f69cebdc2ec7ec76a231cb0f176625b39cbc8943) Thanks [@paoun-ledger](https://github.com/paoun-ledger)! - Add `APEX` device model support to the clear-signing and transaction-check codec

### Patch Changes

- [#1736](https://github.com/LedgerHQ/device-sdk-ts/pull/1736) [`e6bbdd5`](https://github.com/LedgerHQ/device-sdk-ts/commit/e6bbdd55fbb96c2d9a45a2afbd64dd496eae439d) Thanks [@paoun-ledger](https://github.com/paoun-ledger)! - Accept Solana instruction descriptors without `discriminator_hex`.

- [#1712](https://github.com/LedgerHQ/device-sdk-ts/pull/1712) [`0e942f4`](https://github.com/LedgerHQ/device-sdk-ts/commit/0e942f43b2a14f7eb482da5d418696dc493d17f7) Thanks [@fAnselmi-Ledger](https://github.com/fAnselmi-Ledger)! - Forward cosigners for Solana txc
...
- [#1326](https://github.com/LedgerHQ/device-sdk-ts/pull/1326) [`f42443c`](https://github.com/LedgerHQ/device-sdk-ts/commit/f42443c2fbbcef0d5a563a8ed3bee29e7579885d) Thanks [@aussedatlo](https://github.com/aussedatlo)! - Add gated signing module: GATED_SIGNING context type, certificate support, and loaders for gated descriptors (transactions and typed data). Used by signer-eth when app version supports gating (1.22.0+).
...
- [#807](https://github.com/LedgerHQ/device-sdk-ts/pull/807) [`8e0d9ba`](https://github.com/LedgerHQ/device-sdk-ts/commit/8e0d9ba3b18c101edbe40b00f8f011812dc081d4) Thanks [@aussedatlo](https://github.com/aussedatlo)! - Add origin token for transaction checks call
