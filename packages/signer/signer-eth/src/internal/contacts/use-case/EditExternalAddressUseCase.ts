...
@injectable()
export class EditExternalAddressUseCase {
  ...
  execute(args: EditExternalAddressArgs): EditExternalAddressDAReturnType {
    ...
    validateAddressHex(args.oldAddressHex, {
      expectedBytes: ETH_ADDRESS_BYTES,
    });
    validateAddressHex(args.newAddressHex, {
      expectedBytes: ETH_ADDRESS_BYTES,
    });
    ...
    return this._appBinder.editExternalAddress({
      ...args,
