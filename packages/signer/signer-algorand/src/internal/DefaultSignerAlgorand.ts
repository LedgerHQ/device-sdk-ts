...
import { type SignerAlgorand } from "@api/SignerAlgorand";
...
type DefaultSignerAlgorandConstructorArgs = {
  dmk: DeviceManagementKit;
  sessionId: DeviceSessionId;
};

export class DefaultSignerAlgorand implements SignerAlgorand {
  private readonly _container: Container;

  constructor({ dmk, sessionId }: DefaultSignerAlgorandConstructorArgs) {
