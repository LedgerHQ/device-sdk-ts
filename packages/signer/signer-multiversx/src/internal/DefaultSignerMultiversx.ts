...
import { type SignerMultiversx } from "@api/SignerMultiversx";
...
type DefaultSignerMultiversxConstructorArgs = {
  dmk: DeviceManagementKit;
  sessionId: DeviceSessionId;
};

export class DefaultSignerMultiversx implements SignerMultiversx {
  private readonly _container: Container;

  constructor({ dmk, sessionId }: DefaultSignerMultiversxConstructorArgs) {
