...
import { type SignerTezos } from "@api/SignerTezos";
...
type DefaultSignerTezosConstructorArgs = {
  dmk: DeviceManagementKit;
  sessionId: DeviceSessionId;
};

export class DefaultSignerTezos implements SignerTezos {
  private readonly _container: Container;

  constructor({ dmk, sessionId }: DefaultSignerTezosConstructorArgs) {
