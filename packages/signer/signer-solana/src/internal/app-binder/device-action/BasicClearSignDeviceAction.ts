 ...
 */
export type BasicClearSignDAOutput = void;

export type BasicClearSignDAInput = {
...
export type BasicClearSignDAError = SignTransactionDAError;

export type BasicClearSignDAIntermediateValue = {
  requiredUserInteraction: UserInteractionRequired;
  step: SignTransactionDAStateStep;
};

export type BasicClearSignDAInternalState = {
...
export type BasicClearSignDAState = DeviceActionState<
  BasicClearSignDAOutput,
  BasicClearSignDAError,
  BasicClearSignDAIntermediateValue
>;
 ...
 */
export class BasicClearSignDeviceAction extends XStateDeviceAction<
  BasicClearSignDAOutput,
  BasicClearSignDAInput,
  BasicClearSignDAError,
  BasicClearSignDAIntermediateValue,
  BasicClearSignDAInternalState
> {
  makeStateMachine(
