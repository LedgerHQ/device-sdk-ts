...
import {
  type BasicClearSignDAError,
  type BasicClearSignDAInput,
  type BasicClearSignDAIntermediateValue,
  BasicClearSignDeviceAction,
} from "./BasicClearSignDeviceAction";
...
function run(
  ...
  const action = new BasicClearSignDeviceAction({ input });
...
const splInput: BasicClearSignDAInput = {
...
describe("BasicClearSignDeviceAction", () => {
  beforeEach(() => {
