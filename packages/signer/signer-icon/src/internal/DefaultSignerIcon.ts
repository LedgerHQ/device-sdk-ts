...
import { type SignerIcon } from "@api/SignerIcon";
...
type DefaultSignerIconConstructorArgs = {
  dmk: DeviceManagementKit;
  sessionId: DeviceSessionId;
};

export class DefaultSignerIcon implements SignerIcon {
  private readonly _container: Container;

  constructor({ dmk, sessionId }: DefaultSignerIconConstructorArgs) {
