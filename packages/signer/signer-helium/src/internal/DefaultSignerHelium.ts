...
import { type SignerHelium } from "@api/SignerHelium";
...
type DefaultSignerHeliumConstructorArgs = {
  dmk: DeviceManagementKit;
  sessionId: DeviceSessionId;
};

export class DefaultSignerHelium implements SignerHelium {
  private readonly _container: Container;

  constructor({ dmk, sessionId }: DefaultSignerHeliumConstructorArgs) {
