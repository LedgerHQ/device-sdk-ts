...
import { type SignerCelo } from "@api/SignerCelo";
...
type DefaultSignerCeloConstructorArgs = {
  dmk: DeviceManagementKit;
  sessionId: DeviceSessionId;
};

export class DefaultSignerCelo implements SignerCelo {
  private readonly _container: Container;

  constructor({ dmk, sessionId }: DefaultSignerCeloConstructorArgs) {
