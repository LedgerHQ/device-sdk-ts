...
import { type CantonErrorCodes } from "./utils/cantonAppErrors";
...
export class SignMessageCommand
  implements Command<SignMessageCommandResponse, SignMessageCommandArgs, CantonErrorCodes>
{
  ...
  ): CommandResult<SignMessageCommandResponse, CantonErrorCodes> {
    return CommandResultFactory({
      error: new InvalidStatusWordError(
        "Canton uses signTransaction for all signing operations. Use signTransaction instead.",
      ),
    });
  }
}
