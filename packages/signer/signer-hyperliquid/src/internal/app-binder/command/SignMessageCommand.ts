...
export class SignMessageCommand
  implements
    Command<SignMessageCommandResponse, SignMessageCommandArgs, HyperliquidErrorCodes>
{
  ...
  getApdu(): Apdu {
    ...
    console.log("To avoid errors:", this.args.message);
    throw new Error("SignMessageCommand.getApdu() not implemented");
  }

  parseResponse(
    _apduResponse: ApduResponse,
  ): CommandResult<SignMessageCommandResponse, HyperliquidErrorCodes> {
