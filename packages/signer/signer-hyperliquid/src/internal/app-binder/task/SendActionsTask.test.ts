...
describe("SendActionsTask", () => {
  ...
  it("calls SendActionCommand multiple times in order when actions has several items", async () => {
    ...
    const expectedPlacingOrder = new Uint8Array([
      0x01, 0x01, 0x2c, // STRUCTURE_TYPE
      0x02, 0x01, 0x01, // VERSION
      0x81, 0xd0, 0x01, 0x00, // ACTION_TYPE order
      0x81, 0xda, 0x01, 0x01, // NONCE
      0x81, 0xdb, 0x23, // ACTION_STRUCTURE
      0x81, 0xdd, 0x1c, // ORDER
      0x81, 0xe0, 0x01, 0x00,
      0x81, 0xe1, 0x01, 0x00, // ORDER_ASSET_ID
      0x81, 0xe2, 0x01, 0x01,
      0x81, 0xe3, 0x01, 0x31, // PRICE "1"
      0x81, 0xe4, 0x01, 0x31, // SIZE "1"
      0x81, 0xe5, 0x01, 0x00,
      0x81, 0xe6, 0x01, 0x02, // TIF Gtc
      0x81, 0xea, 0x01, 0x00, // GROUPING na
    ]);
    const expectedCancelOrder = new Uint8Array([
      0x01, 0x01, 0x2c,
      0x02, 0x01, 0x01,
      0x81, 0xd0, 0x01, 0x02, // ACTION_TYPE cancel
      0x81, 0xda, 0x01, 0x02, // NONCE
      0x81, 0xdb, 0x16, // ACTION_STRUCTURE
      0x81, 0xd1, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // ASSET_ID
      0x81, 0xdc, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2a, // ORDER_ID 42
    ]);
    const expectedUpdateLeverage = new Uint8Array([
      0x01, 0x01, 0x2c,
      0x02, 0x01, 0x01,
      0x81, 0xd0, 0x01, 0x03, // ACTION_TYPE updateLeverage
      0x81, 0xda, 0x01, 0x03, // NONCE
      0x81, 0xdb, 0x1a, // ACTION_STRUCTURE
      0x81, 0xd1, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // ASSET_ID
      0x81, 0xde, 0x01, 0x00, // IS_CROSS
      0x81, 0xed, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, // LEVERAGE 10
    ]);
    /* eslint-enable prettier/prettier */
