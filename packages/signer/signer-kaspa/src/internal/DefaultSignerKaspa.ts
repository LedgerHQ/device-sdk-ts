...
import { type SignerKaspa } from "@api/SignerKaspa";
...
type DefaultSignerKaspaConstructorArgs = {
  dmk: DeviceManagementKit;
  sessionId: DeviceSessionId;
};

export class DefaultSignerKaspa implements SignerKaspa {
  private readonly _container: Container;

  constructor({ dmk, sessionId }: DefaultSignerKaspaConstructorArgs) {
