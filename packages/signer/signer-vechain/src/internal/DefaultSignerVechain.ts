...
import { type SignerVechain } from "@api/SignerVechain";
...
type DefaultSignerVechainConstructorArgs = {
  dmk: DeviceManagementKit;
  sessionId: DeviceSessionId;
};

export class DefaultSignerVechain implements SignerVechain {
  private readonly _container: Container;

  constructor({ dmk, sessionId }: DefaultSignerVechainConstructorArgs) {
