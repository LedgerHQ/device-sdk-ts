...
export class SignTransactionTask {
  ...
  async run(): Promise<CommandResult<Signature, ConcordiumErrorCodes>> {
    ...
    // Combine path + transaction for sending
    ...
    let lastResult: CommandResult<SignTransactionCommandResponse, ConcordiumErrorCodes> | undefined;
