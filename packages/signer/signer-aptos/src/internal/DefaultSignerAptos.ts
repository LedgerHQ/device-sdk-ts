...
import { type SignerAptos } from "@api/SignerAptos";
...
type DefaultSignerAptosConstructorArgs = {
  dmk: DeviceManagementKit;
  sessionId: DeviceSessionId;
};

export class DefaultSignerAptos implements SignerAptos {
  private readonly _container: Container;

  constructor({ dmk, sessionId }: DefaultSignerAptosConstructorArgs) {
