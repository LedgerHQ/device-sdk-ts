...
import { type SignerStellar } from "@api/SignerStellar";
...
type DefaultSignerStellarConstructorArgs = {
  dmk: DeviceManagementKit;
  sessionId: DeviceSessionId;
};

export class DefaultSignerStellar implements SignerStellar {
  private readonly _container: Container;

  constructor({ dmk, sessionId }: DefaultSignerStellarConstructorArgs) {
