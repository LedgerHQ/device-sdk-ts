...
describe("SignChallengeWithKeypairTask", () => {
  ...
  it("should handle invalid keypair", async () => {
    // GIVEN
    const { challenge, keypair, trustchainId } = getParameters({
      privateKey:
        "012345678901234567890123456789012345678901234567890123456789012345", // Invalid key
    });
    ...
    result.ifLeft((error) => expect(error).toBeInstanceOf(UnknownDAError));
  });
...
function getParameters({
  ...
  publicKey = "3045022100e9fead4e341f4e145f8888d7897184ff585e23c832a4c7acd15b5a2e53c58d2902204c58596d039960ab9b56ba4f9d27dbc5e647dbe779089e5e7e608501c5270049",
