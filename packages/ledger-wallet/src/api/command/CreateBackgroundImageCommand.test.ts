...
import {
  ...
  CreateBackgroundImageCommandError,
} from "./CreateBackgroundImageCommand";
  ...
  describe("parseResponse", () => {
    ...
    it("should return error on user refused (5501)", () => {
      ...
      if (!isSuccessCommandResult(result)) {
        expect(result.error).toBeInstanceOf(CreateBackgroundImageCommandError);
        expect(
          (result.error as CreateBackgroundImageCommandError).message,
