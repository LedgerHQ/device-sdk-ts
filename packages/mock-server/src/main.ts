import { DEFAULT_SPECULOS_SEED } from "./speculos/SpeculinhoClient";
import { logger } from "./logger";
import { createMockServer, type MockServerOptions } from "./MockServer";
...
const speculos: MockServerOptions["speculos"] = speculinhoUrl
  ? {
