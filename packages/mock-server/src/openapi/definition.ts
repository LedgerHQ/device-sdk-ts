 ...
 * Express handlers (see `src/routes/*.ts`) and merged in by `swagger-jsdoc`.
 * The reusable component schemas below mirror the public types exported from
 * `@ledgerhq/device-mockserver-client`; keep them in sync when those change.
 */
